...
Future<void> _configureAmplify() async {
  try {
    ...
    safePrint('Error configured AMplify: $e');
  }
}
    ...
    return Authenticator(
      ...
      authenticatorBuilder: (BuildContext context, AuthenticatorState state) {
        switch (state.currentStep) {
          ...
          default:
            // Return null defaults to the prebuilt authenticator for all other steps
            return null;
        }
      },
      child: MaterialApp(
...
/// A widget that display a logo, a body, and an optional footer
